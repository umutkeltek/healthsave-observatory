...
echo "  If you've layered deploy/reverse-proxy/docker-compose.proxy.override.yml"
echo "  on top of this deploy, the canonical ingress is:"
echo "    https://$REMOTE_HOST:${PROXY_HTTPS_PORT:-443}/"
echo "  (HTTP 18080 redirects to HTTPS 18443 on the same host.)"
