...
-- ─── Personal context moments (migration 023) ─────────────────────
-- Illness, travel, lifestyle events that explain or confound physiological
-- changes. Host-local; never eligible for egress.
